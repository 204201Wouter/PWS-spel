...
public class WeaponScript : MonoBehaviour
{
    ...
    {                              //dmg
        ...
        scopes.Add("scopeding", new(4, "scopeding", GameObject.Find("scope"), scopeSprite, scopeSpriteBig)); // scopeSprite vervangen voor nieuwe sprite dan
        scopes.Add("no scope", new(2, "no scope", GameObject.Find("red dot sight"), null, reddotSpriteBig));
        // hier alle scopes
